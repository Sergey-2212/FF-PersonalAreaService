...
public class ActivityServiceTest {
    ...
    public void getActivityByTitleTest() {
        ...
        Assertions.assertEquals(ActivityTitle.MIN_ACTIVITY.toString(), activityService.getByTitle(ActivityTitle.MIN_ACTIVITY.toString()).getTitle());
        Assertions.assertThrows(NotFoundException.class, () -> activityService.getByTitle("activity"));
    }
    ...
    public void getActivityByIdTest() {
        ...
        Assertions.assertEquals(ActivityTitle.MIN_ACTIVITY.toString(), activityService.getById(1L).getTitle());
        Assertions.assertThrows(NotFoundException.class, () -> activityService.getById(2L));
    }

    @Test
    public void listOfActivityTitlesTest() {
        Mockito.doReturn(getListOfTestEntities()).when(activityRepository).findAll();
        Assertions.assertEquals(ActivityTitle.MIN_ACTIVITY.toString(), activityService.getAllTitles().get(0));
    }
